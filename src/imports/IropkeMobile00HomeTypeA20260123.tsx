...
import svgPaths from "./svg-d9bod9u3b1";
...
function Logo() {
  return (
    <div className="content-stretch flex h-[18px] items-start relative shrink-0" data-name="Logo">
      <IropkeLogo />
    </div>
  );
}
...
function ButtonLightTheme() {
  return (
    <div className="content-stretch flex h-[36px] items-center justify-center px-[10px] py-[11px] relative rounded-[5px] shrink-0" data-name="Button - Light Theme">
      ...
      <p className="css-ew64yg font-['Roboto:Roboto',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#232329] text-[13px] text-center">Project Inquiry</p>
    </div>
  );
}
...
function Header() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[8px]" data-name="Header">
      <div aria-hidden="true" className="absolute border border-[#e8eaed] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_7px_20px_0px_rgba(0,0,0,0.08)]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between pl-[15px] pr-[10px] py-[10px] relative w-full">
          <Logo />
          <Buttons />
        </div>
      </div>
...
function Header1() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-0 p-[10px] top-0 w-[360px] z-[6]" data-name="Header">
      <Header />
    </div>
  );
}
...
function Hero() {
  return (
    <div className="h-[640px] relative shrink-0 w-full z-[5]" data-name="Hero">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgHero} />
      <div className="flex flex-col justify-end size-full">
        <div className="content-stretch flex flex-col items-start justify-end px-[16px] py-[40px] relative size-full">
          <Container />
        </div>
      </div>
    </div>
...
function Arrow() {
  return (
    <div className="absolute bottom-[-0.5px] content-stretch flex items-end justify-end p-[20px] right-0 size-[60px]" data-name="Arrow">
      <UtilityIcons1 />
    </div>
  );
}
...
function Box() {
  return (
    <div className="bg-white relative rounded-[8px] shrink-0 w-full" data-name="Box">
      ...
      <div aria-hidden="true" className="absolute border border-[#dfdfe4] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
}
...
function BusinessArea() {
  return (
    <div className="relative shrink-0 w-full z-[4]" data-name="Business Area">
      <div className="content-stretch flex flex-col gap-[20px] items-start px-[16px] py-[60px] relative w-full">
        <Headline1 />
        <Container1 />
      </div>
    </div>
...
function Headline3() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[20px] relative shrink-0 w-full" data-name="Headline">
      <Headline2 />
    </div>
  );
}
...
function Title8() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Title">
      <p className="css-4hzbpn font-['Google_Sans:Google_Sans',sans-serif] h-[47px] leading-[1.2] not-italic overflow-hidden relative shrink-0 text-[#232329] text-[20px] text-ellipsis w-full">Transforming a Traditional FAQ Page into an AI-Powered Chatbot</p>
    </div>
  );
}
...
function UtilityIcons7() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Utility Icons">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Utility Icons">
          <path d={svgPaths.p3b6ad300} id="icon-arrow-right" stroke="var(--stroke-0, #68687B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        </g>
...
function Arrow6() {
  return (
    <div className="content-stretch flex items-center pb-[20px] px-[20px] relative shrink-0" data-name="Arrow">
      <UtilityIcons7 />
    </div>
  );
}
...
function Post() {
  return (
    <div className="bg-white relative rounded-[8px] shrink-0 w-full" data-name="Post">
      <div className="content-stretch flex flex-col items-end justify-end overflow-clip relative rounded-[inherit] w-full">
        <div className="aspect-[160/90] relative shrink-0 w-full" data-name="home-post-thumb-01">
          <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
...
function Title9() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Title">
      <p className="css-4hzbpn font-['Google_Sans:Google_Sans',sans-serif] h-[47px] leading-[1.2] not-italic overflow-hidden relative shrink-0 text-[#232329] text-[20px] text-ellipsis w-full">What Needs to Change in the Marketing Funnel in the Age of AI?</p>
    </div>
  );
}
...
function Title10() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Title">
      <p className="css-4hzbpn font-['Google_Sans:Google_Sans',sans-serif] h-[47px] leading-[1.2] not-italic overflow-hidden relative shrink-0 text-[#232329] text-[20px] text-ellipsis w-full">The Future Is Already Here: Web Service Strategies for Seniors</p>
    </div>
  );
}
...
function List() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start justify-center relative shrink-0 w-full" data-name="List">
      <Post />
      <Post1 />
      <Post2 />
    </div>
...
function Copy9() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[25px] items-start min-h-px min-w-px not-italic relative text-white" data-name="Copy">
      <Title12 />
      <p className="css-4hzbpn font-['Roboto:Roboto',sans-serif] leading-[1.5] opacity-80 relative shrink-0 text-[13px] w-full">From AI adoption consulting to AI agent development, we provide end-to-end AX (AI Transformation) services across workflows, organizational structures, and platforms.</p>
    </div>
  );
}
...
function InquiryBox() {
  return (
    <div className="relative rounded-[8px] shrink-0 w-full" data-name="Inquiry Box">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[8px] size-full" src={imgInquiryBox} />
      <div className="flex flex-row items-end overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[5px] items-end p-[20px] relative w-full">
          <Copy9 />
          <Arrow9 />
        </div>
      </div>
...
function Copy10() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[25px] items-start min-h-px min-w-px not-italic relative text-white" data-name="Copy">
      <Title13 />
      <p className="css-4hzbpn font-['Roboto:Roboto',sans-serif] leading-[1.5] opacity-80 relative shrink-0 text-[13px] w-full">Beyond traditional SEO, we design and execute AEO/GEO-focused search optimization strategies that help brands and services be recognized, recommended, and trusted in AI-driven search and recommendation environments.</p>
    </div>
  );
}
...
function InquiryBox1() {
  return (
    <div className="relative rounded-[8px] shrink-0 w-full" data-name="Inquiry Box">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[8px] size-full" src={imgInquiryBox1} />
      <div className="flex flex-row items-end overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[5px] items-end p-[20px] relative w-full">
          <Copy10 />
          <Arrow10 />
...
function Inquiry() {
  return (
    <div className="relative shrink-0 w-full z-[2]" data-name="Inquiry">
      <div className="content-stretch flex flex-col gap-[20px] items-start pb-[60px] px-[16px] relative w-full">
        <Headline4 />
        <Container2 />
      </div>
    </div>
...
export default function IropkeMobile00HomeTypeA() {
  return (
    <div className="bg-[#f3f4f7] content-stretch flex flex-col isolate items-start relative size-full" data-name="IROPKE_Mobile_00_Home_TypeA_20260123">
      <Header1 />
      <Hero />
      <BusinessArea />
      <PopularInsight />
